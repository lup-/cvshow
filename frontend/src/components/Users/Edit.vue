                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-form autocomplete="off">
                            ...
                            ></v-text-field>
                            <v-switch v-model="user.isAdmin" label="Администратор" v-if="hasRights('userList')"></v-switch>
                            <v-autocomplete v-if="hasRights('userList')"
                                    :items="rights"
                                    v-model="user.rights"
                                    chips
                                    deletable-chips
                    ...
                    <v-card-actions>
                        <v-btn @click="$router.push({name: 'userList'})">К списку</v-btn>
